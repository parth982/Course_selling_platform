...
export const dummyTestimonials: TestiAuthorProps[] = [
  {
    name: "John Doe",
    designation: "CEO, ABC Company",
    img: {
      src: "/images/testi/user1.png",
      alt: "John Doe",
      height: 407,
      width: 308,
    },
